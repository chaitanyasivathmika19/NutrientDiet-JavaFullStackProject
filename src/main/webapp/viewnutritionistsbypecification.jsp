...
<!--         <div class="option-card">
        ...
        <!-- Sports Nutritionist -->
<div class="option-card">
    <img src="images/sports_nutritionist.jpg" alt="Sports Nutritionist">
    <div class="option-info">
        <h3>Sports Nutritionist</h3>
        <button class="icon-btn" onclick="window.location.href='viewallNutritionists?nspecification=sportsnutritionist';">Select</button>
    </div>
</div>
        ...
        <div class="option-card">
            <img src="images/weight_loss_nutritionist.jpg" alt="Weight Loss Nutritionist">
            <div class="option-info">
        ...
        <div class="option-card">
            <img src="images/weight_loss_nutritionist.jpg" alt="Weight Loss Nutritionist">
            <div class="option-info">
                <h3>Cardiac Nutritionist</h3>
                <button class="icon-btn" onclick="window.location.href='viewallNutritionists?nspecification=cardiac';">Select</button>
            </div>
        </div>

        <!-- Teenage Nutritionist -->
        <div class="option-card">
            <img src="images/teenage_nutritionist.jpg" alt="Teenage Nutritionist">
            <div class="option-info">
        ...
        <div class="option-card">
            <img src="images/general_nutritionist.jpg" alt="General Nutritionist">
            <div class="option-info">
